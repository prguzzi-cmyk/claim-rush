    ...
    def create(self, db_session: Session) -> dict[str, RoleModel]:
        ...
        for role, permissions in self.roles.items():
            ...
            if not role_obj:
                ...
                # TODO: Optimize system default role permissions assignment
                if result.display_name == Roles.AGENT.value:
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.TAG.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.FILE.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.CLAIM_PAYMENT.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.NPO_INITIATIVE.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.PARTNERSHIP.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.NETWORK.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.NEWSLETTER.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.NEWSLETTER_FILE.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.ANNOUNCEMENT.value,
                        read_only=True,
                    )
                    crud.role.append_module_permissions(
                        db_session,
                        role_obj=result,
                        module_name=Modules.ANNOUNCEMENT_FILE.value,
                        read_only=True,
                    )
        return roles
